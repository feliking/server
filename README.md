...
Base de datos en archivos JSON con los servicios REST implementados
...
* Iniciar el servidor `npm start`, usa la dirección `http://localhost:3000` para recibir las peticiones
